...
speedNR=Number_Spedometr([0.55-4*0.05-0.1, -0.15 ,-1.0], 0.05)
speedNL=Number_Spedometr([-0.55, -0.15 ,-1.0], 0.05)
...
def initGL():
    ...
    num_spedometr_texture.set_image("numbers_v3.png")
...
def draw_arrow(texture0):
    ...
    glVertex3f(-coordX, texture0.vertexcoord1[1], -50.0)
    glVertex3f(-coordX, texture0.vertexcoord1[1], 50.0)
    glVertex3f(-coordX+H, texture0.vertexcoord1[1], 50.0)
    glVertex3f(-coordX+H, texture0.vertexcoord1[1], -50.0)
    glEnd()
...
def draw_callback0(GST_object, width, height, texture):
    ...
    speedNR.set_motor_power(speedR_now)
    speedNL.set_motor_power(speedL_now)
