...
def initGL ():
    ...
    textureImage = loadImageStr("kompas.png")
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, 4, 900, 800, 0, GL_RGBA, GL_UNSIGNED_BYTE, textureImage)
...
def draw_callback0(GST_object, width, height, texture):
    ...
    gluLookAt(15,-15,15,15+math.sin(angle_list[0]/180*3.14),-15+math.tan((180-angle_list[1])/180*3.14), 15-math.cos(angle_list[0]/180*3.14),0,1,0)

    #print(-math.sin(angle_list[0]/180*3.14))
