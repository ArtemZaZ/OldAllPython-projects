...
def draw_callback1(GST_object, width, height, texture):
    ...
    glPushMatrix()
    gluLookAt(0.0+coord_list[0], -7+coord_list[1], 0.0+coord_list[2], coord_list[0]+math.sin(ang[0]/180*math.pi),-7+coord_list[1]+math.tan((180-ang[1])/180*math.pi), coord_list[2]-math.cos(ang[0]/180*math.pi), 0.0, 1.0, 0.0)
